...
class HumanShapeAnalysisDemo(QtGui.QMainWindow):
  def __init__(self, test):
    ...
    self.setWindowTitle("KETI _ 3D Body Estimation 프로그램 포트번호 : 5566")
  ...
  def set_menu(self):
    ...
    self.setToolTip('환경 설정을 할 수 있습니다.')
  ...
  def set_button(self):
    ...
    self.reset_button = QtGui.QPushButton("리셋하기")
    ...
    self.pre_button = QtGui.QPushButton("예측하기")
